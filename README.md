...
一个基于 Chrome Manifest V3 的浏览器扩展，用来把 `mp.weixin.qq.com` 的公众号文章与 `zhuanlan.zhihu.com` 的知乎专栏文章下载为：
...
- 支持 `https://mp.weixin.qq.com/*` 与 `https://zhuanlan.zhihu.com/p/*` 文章页
...
对应的离线 fixture 保存在 `tests/fixtures/weixin-article.html` 与 `tests/fixtures/zhihu-article.html`。
